...
namespace BusStationInterface.Migrations
{
    ...
    [Migration("20240131002915_AddedRouteDescToTicketForm")]
    partial class AddedRouteDescToTicketForm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusStationInterface.Models.Ticket", b =>
                {
                    ...
                    b.Property<int>("EndRouteDetailID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusStationInterface.Models.Ticket", b =>
                {
                    b.HasOne("BusStationInterface.Models.RouteDetail", "EndRouteDetail")
                        .WithMany()
                        .HasForeignKey("EndRouteDetailID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("BusStationInterface.Models.RouteDetail", "StartRouteDetail")
                        .WithMany()
                        .HasForeignKey("StartRouteDetailID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("EndRouteDetail");

                    b.Navigation("Schedule");

                    b.Navigation("Seat");

                    b.Navigation("StartRouteDetail");
                });
